 ...
 */
public final class CollegeDetailService
...
//                CollegeContract.EarningsEntry.buildEarningsWithCollegeId(collegeId),
//                new String[]{CollegeContract.EarningsEntry.COLLEGE_ID}, null, null, null, null);
...
//                values.put(CollegeContract.EarningsEntry.COLLEGE_ID, collegeId);
//                values.put(CollegeContract.EarningsEntry.MED_EARNINGS_25_PCT, college.getInt(MED_EARNINGS_10_YEARS_25_PCT));
//                values.put(CollegeContract.EarningsEntry.MED_EARNINGS_75_PCT, college.getInt(MED_EARNINGS_10_YEARS_75_PCT));
//                values.put(CollegeContract.EarningsEntry.SAT_MED, (int) Math.round(college.getDouble(SAT_EQUIV_AVG)));
//                values.put(CollegeContract.EarningsEntry.ACT_MED, (int) Math.round(college.getDouble(ACT_MED)));
//                values.put(CollegeContract.EarningsEntry.ACT_25_PCT, (int) Math.round(college.getDouble(ACT_25_PERCENTILE)));
//                values.put(CollegeContract.EarningsEntry.ACT_75_PCT, (int) Math.round(college.getDouble(ACT_75_PERCENTILE)));
//                values.put(CollegeContract.EarningsEntry.UNDERGRAD_SIZE, college.getInt(UNDERGRAD_SIZE));
//                values.put(CollegeContract.EarningsEntry.FAMILY_INCOME, college.getInt(MED_FAMILY_INCOME));
//                values.put(CollegeContract.EarningsEntry.GRAD_RATE_4_YEARS, college.getDouble(GRADUATION_RATE_4_YEARS));
//                values.put(CollegeContract.EarningsEntry.LOAN_PRINCIPAL, (int) Math.round(college.getDouble(LOAN_PRINCIPAL)));
//                values.put(CollegeContract.EarningsEntry.MED_DEBT_COMPLETERS, (int) Math.round(college.getDouble(MED_DEBT_COMPLETERS)));
//                values.put(CollegeContract.EarningsEntry.MED_MONTH_PAYMENT, (int) Math.round(college.getDouble(MED_MONTH_PAYMENT)));
//                values.put(CollegeContract.EarningsEntry.LOAN_STUDENTS_PCT, college.getDouble(PCT_LOAN_STUDENTS));
...
//            addCollege(Utility.fetch(finalUrl), collegeId);
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
}
