...
import static com.scholar.dollar.android.dollarscholarbenlewis.service.CollegeService.NAME;
import static com.scholar.dollar.android.dollarscholarbenlewis.service.CollegeService.createFinalUrl;


public class CollegeBasicService extends IntentService {

    private static final String LOG_TAG = CollegeBasicService.class.getSimpleName();


    private String mFilters = CollegeService
            .joinFilters(new ArrayList<String>(Arrays.asList(CollegeService.FILTERS)));
